...
\begin{titlepage}
 \centering
 \includegraphics[height=2.5cm]{./img/2015_Logo_TUM_CMYK.pdf}\\[1cm]
 ...
 \vfill
 \vfill
 \includegraphics[height=2.5cm]{./img/FAK_IN_CMYK.pdf}
 \cleardoublepage
\end{titlepage}
\restoregeometry
...
\thispagestyle{empty}
\begin{center}
 \includegraphics[height=2.5cm]{./img/2015_Logo_TUM_sw_CMYK.pdf}\\[0.8cm]
 {\LARGE \textsc{\myDepartment}}\\[0.8em]
 {\Large \textsc{\myUniversity}}
 \vfill
 \vfill
 ...
 \vfill
 \vfill
 \includegraphics[height=2.5cm]{./img/FAK_IN_sw_CMYK.pdf}
\end{center}
