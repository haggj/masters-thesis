...
\todo{Abkürzungen}
\todo{Safekeeper vs Overseer; Clotiled vs Display --> einheitlich!}
\todo{section oder Section??}
\todo{page numers vs section when citing??}
...
\subfile{./txt/4-overview-solutions.tex}
\subfile{./txt/5-protocol-design.tex}
\subfile{./txt/6-implemented-libraries.tex}
\subfile{./txt/7-evaluation.tex}
