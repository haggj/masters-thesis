...
\begin{figure}[h!]
    \fbox{\includegraphics[scale=0.3]{../img/06/clotilde_overview.png}}
    \centering
...
\newpage
\begin{figure}[h!]
   \fbox{\includegraphics[scale=0.35]{../img/06/clotilde_share.png}}
    \centering
...
\begin{figure}[h!]
    \fbox{\includegraphics[scale=0.35]{../img/06/clotilde_shared.png}}
    \centering
