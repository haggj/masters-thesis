...
\begin{itemize}
    ...
    \item [N3.] Usability
    \item [N5.] Minimal resource utilization
\end{itemize}
...
No untrusted entity within the system can access the content of these logs.
The untrusted network is the whole infrastructure of the toolchain, except trusted servers and the application a user interacts with.
...
This can be fixed if the data owner additionally includes and signs the set of valid receivers into the exchanged message.
