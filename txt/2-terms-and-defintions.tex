...
Thus, a JWE token consist of the components listed in \cref{tab:jwe}~\cite{JWE2015}:
...
\begin{table}[ht]
    ...
    Encrypted Key                 & Stores the encrypted key that was used to encrypt the application data.                                                \\ 
    Initialization Vector         & Contains initialization vectors of the used encryption algorithms.                                                     \\ 
...
It lays the foundation for the attacker models employed in this thesis because it clarifies against which attackers end-to-end encrypted systems defend.
